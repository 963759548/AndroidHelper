 ...
 * @author Juan Silva
 */
public class GetPropertiesCommand extends BaseShellCommand implements ICommand {
	
	/**
	 * Command for list all android devices connected
	 */
	public static final String GET_PROPERTIES_COMMAND = "getprop";
	...
	public String getCommand() {
		return format("%s", GET_PROPERTIES_COMMAND);
	}
}

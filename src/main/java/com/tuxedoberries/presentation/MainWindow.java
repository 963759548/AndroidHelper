...
public class MainWindow extends javax.swing.JFrame implements IProcessStartListener, IProcessStopListener, IUpdate {
	...
	private void initComponents() {
		...
		recordBitrateSlider = new JSlider();
		jLabel3 = new JLabel();
		recordTimeTextField = new JTextField();
		recordBitRateTextField = new JTextField();
		timeValueLable = new JLabel();
		bitRateValueLable = new JLabel();
		jLabel2 = new JLabel();
		logPanel = new JPanel();
		...
		adbPanelLayout
				.setHorizontalGroup(adbPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(adbPanelLayout.createSequentialGroup()
								.addGroup(adbPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										.addGroup(adbPanelLayout.createSequentialGroup().addGap(8, 8, 8)
												.addComponent(jLabel1))
										.addComponent(adbChoosePath))
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addGroup(adbPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										.addGroup(adbPanelLayout.createSequentialGroup().addComponent(adbSaveConfig)
												.addGap(0, 0, Short.MAX_VALUE))
										.addComponent(adbTextField))
								.addContainerGap()));
		adbPanelLayout.setVerticalGroup(adbPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(adbPanelLayout.createSequentialGroup()
						.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addGroup(adbPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabel1).addComponent(adbTextField,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(adbPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(adbChoosePath).addComponent(adbSaveConfig))));

		screenRecordPanel.setBorder(javax.swing.BorderFactory.createTitledBorder("Screen Record"));

		recordTimeSlider.setMaximum(ADBConfiguration.MAX_RECORD_TIME);
		recordTimeSlider.setValue(ADBConfiguration.currentRecordTime);
		...
		recordBitrateSlider.setMaximum(ADBConfiguration.MAX_RECORD_BIT_RATE);
		recordBitrateSlider.setValue(ADBConfiguration.currentBitRate);
		recordBitrateSlider.addChangeListener(new javax.swing.event.ChangeListener() {
			public void stateChanged(javax.swing.event.ChangeEvent evt) {
				updateBitRate(recordBitrateSlider.getValue());
			}
		});

		jLabel3.setText("Time per video [0 - 180 Seconds]");

		recordTimeTextField.setText(String.format("%d", ADBConfiguration.currentRecordTime));
		...
		recordBitRateTextField.setText(String.format("%d", ADBConfiguration.currentBitRate));
		recordBitRateTextField.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				recordBitRateTextFieldActionPerformed(evt);
			}
		});

		timeValueLable.setText("Time:");
		bitRateValueLable.setText("Bit-Rate:");

		jLabel2.setText(
				"<html>If the session last for more than the time<br>set here, another video will be recorder</html>");
		...
		screenRecordPanelLayout.setHorizontalGroup(screenRecordPanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(screenRecordPanelLayout.createSequentialGroup().addContainerGap()
						.addGroup(screenRecordPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(recordTimeSlider, javax.swing.GroupLayout.Alignment.TRAILING,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										Short.MAX_VALUE)
								.addComponent(recordBitrateSlider, javax.swing.GroupLayout.Alignment.TRAILING,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										Short.MAX_VALUE)
								.addGroup(screenRecordPanelLayout.createSequentialGroup()
										.addGroup(screenRecordPanelLayout
												.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
												.addComponent(jLabel3)
												.addGroup(screenRecordPanelLayout.createSequentialGroup()
														.addComponent(timeValueLable)
														.addPreferredGap(
																javax.swing.LayoutStyle.ComponentPlacement.RELATED)
														.addComponent(recordTimeTextField,
																javax.swing.GroupLayout.PREFERRED_SIZE, 64,
																javax.swing.GroupLayout.PREFERRED_SIZE)
														.addComponent(bitRateValueLable)
														.addPreferredGap(
																javax.swing.LayoutStyle.ComponentPlacement.RELATED)
														.addComponent(recordBitRateTextField,
																javax.swing.GroupLayout.PREFERRED_SIZE, 128,
																javax.swing.GroupLayout.PREFERRED_SIZE))
												.addComponent(jLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, 262,
														javax.swing.GroupLayout.PREFERRED_SIZE))
										.addGap(0, 0, Short.MAX_VALUE)))));
		screenRecordPanelLayout.setVerticalGroup(screenRecordPanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, screenRecordPanelLayout.createSequentialGroup()
						...
						.addGroup(screenRecordPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(timeValueLable)
								.addComponent(recordTimeTextField, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(bitRateValueLable).addComponent(recordBitRateTextField,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(recordTimeSlider, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addComponent(recordBitrateSlider, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)));
		...
		screenRecordCheckBox.setToolTipText(
				"Record the display of the device while testing. Set the time limit of the record from 0 to 180 seconds.");
		...
		logPanelLayout.setHorizontalGroup(logPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
						logPanelLayout.createSequentialGroup().addGap(0, 0, Short.MAX_VALUE)
								.addComponent(captureScreenButton).addComponent(startLogButton))
				.addGroup(logPanelLayout.createSequentialGroup().addContainerGap()
						.addGroup(logPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
								.addComponent(screenRecordCheckBox, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(showWindowCheckBox, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(deviceInfoCheckBox, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(deviceLogCheckBox, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
						.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		logPanelLayout
				.setVerticalGroup(
						logPanelLayout
								...
								.addGroup(logPanelLayout.createSequentialGroup().addComponent(deviceLogCheckBox)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
										...
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addGroup(logPanelLayout
												.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
												.addComponent(startLogButton).addComponent(captureScreenButton))));
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup().addContainerGap()
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(processStateLabel, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addGroup(jPanel1Layout.createSequentialGroup().addComponent(jLabel5).addGap(18, 18, 18)
										.addComponent(screenRecordProgress, javax.swing.GroupLayout.DEFAULT_SIZE, 331,
												Short.MAX_VALUE)))
						.addContainerGap()));
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup().addContainerGap().addComponent(processStateLabel)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
								.addComponent(screenRecordProgress, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout
				...
				.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addComponent(adbPanel, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addComponent(jPanel1, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addGroup(layout.createSequentialGroup()
								.addComponent(screenRecordPanel, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
		...
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup().addContainerGap()
						.addComponent(adbPanel, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(logPanel, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(screenRecordPanel, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
	...
	private void setEnableGroup(boolean enable) {
		...
		// BitRate
		recordBitrateSlider.setEnabled(enable);
		recordBitRateTextField.setEnabled(enable);
		// ADB
	...
	private void recordBitRateTextFieldActionPerformed(java.awt.event.ActionEvent evt) {
		String text = recordBitRateTextField.getText();
		if (!TextToNumberHelper.canParseToInt(text)) {
			updateRecordBitRate();
			return;
		}
		int textValue = Integer.parseInt(text);
		if (!(0 <= textValue && textValue <= ADBConfiguration.MAX_RECORD_BIT_RATE)) {
			updateRecordBitRate();
			return;
		}

		updateBitRate(textValue);
	}
	...
	private void updateRecordBitRate() {
		updateRecordTime(ADBConfiguration.currentRecordTime);
	}
	...
	private void updateBitRate(int bitRate) {
		ADBConfiguration.currentBitRate = bitRate;
		recordBitRateTextField.setText(String.format("%d", bitRate));
		recordBitrateSlider.setValue(bitRate);
	}
